      ...
      <>
        <section className="bg-gradient-to-br from-[var(--primary)] to-[var(--primary-light)] text-white py-16 md:py-24">
          <div className="container-main">
            <p className="text-white/80 font-medium mb-2 tracking-wide uppercase text-sm">Contact</p>
          ...
          <div className="container-main max-w-2xl">
            <div className="card text-center">
              <div className="card-body py-12">
                ...
                <h2 className="text-2xl font-bold text-[var(--primary)] mb-3">Message Sent!</h2>
            ...
            {contactInfo.map(info => (
              <div key={info.title} className="card">
                <div className="card-body text-center">
                  ...
                  <h3 className="text-lg font-bold text-[var(--primary)] mb-2">{info.title}</h3>
      ...
      <section className="section bg-white">
        <div className="container-main">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div>
              <h2 className="text-2xl font-bold text-[var(--primary)] mb-6">Find Us</h2>
              <div className="card overflow-hidden">
                <div className="bg-[var(--surface)] h-64 sm:h-80 md:h-full min-h-[300px] flex items-center justify-center">
                  <div className="text-center p-6">
                    <span className="text-4xl block mb-3">📍</span>
                    <p className="font-bold text-[var(--primary)] mb-1">123 Education Drive</p>
                    <p className="text-[var(--muted)] text-sm">Academic City, ST 12345</p>
                    <a href="https://maps.google.com" target="_blank" rel="noopener noreferrer" className="inline-block mt-4 text-sm text-[var(--primary)] hover:text-[var(--primary-light)] underline">
                      Open in Google Maps →
                    </a>
                  </div>
                </div>
